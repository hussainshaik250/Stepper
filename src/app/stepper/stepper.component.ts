import { Component,ViewChild,AfterViewInit,OnInit, NgModule,Output } from '@angular/core';
...
export class StepperComponent  implements OnInit {
  ...
  displayedColumns: string[] = ['id', 'firstname', 'lastname', 'mobilenumber','emailid','accountnumber','ifsccode','holdername','address','language','dateofbirth','action'];
